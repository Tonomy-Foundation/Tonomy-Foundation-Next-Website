        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6">
            <div className="description">
              ...
              identity back in the hands of the individual. With SSI, you can be
              confident that your personal data is secure and private, and that
              you control who has access to it.
              <br /> No more giving away your personal information to
              third-party providers just to log in to your favorite websites or
              apps.
              <br /> Tonomy offers the most secure and easy-to-use digital login
              system in the world, built on the revolutionary technology of
