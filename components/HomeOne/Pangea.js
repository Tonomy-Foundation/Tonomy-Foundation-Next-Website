...
class Pangea extends Component {
    render() {
        return (
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="about-img">
                                <img src="/images/pangea-large-logo.png" alt="Image" />
                            </div>
                        </div>

                        <div className="col-lg-6">
                            <div className="about-content">
                                <span>The First Autonomous Ecosystem</span>
                                <h2>Pangea Virtual Nation and LEOS (Ƚ)</h2>
