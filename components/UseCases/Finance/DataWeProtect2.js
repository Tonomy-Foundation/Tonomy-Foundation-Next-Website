...
class DataWeProtect2 extends Component {
    render() {
        return (
                            ...
                            <div className="single-offer">
                                ...
                                <h3>
                                    <Link href="/service-details">
                                        <a>Client Confidential Information</a>
                                    </Link>
                                </h3>
                                ...
                                <p>Safeguarding this sensitive information is vital to maintain client trust, comply with data protection laws, and prevent data breaches that could lead to financial losses and reputational damage.</p>                            </div>
                        </div>
