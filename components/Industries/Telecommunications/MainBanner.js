                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="banner-text">
                            <h1>Telecommunications Demands Cutting Edge Cybersecurity</h1>
                            <p>Ensure a compliant, data breach resistant Identity Management Framework for your telecom customers and enhance your company’s level of security.</p>
