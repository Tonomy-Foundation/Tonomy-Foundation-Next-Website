                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="banner-text">
                            <h1>Simplify Your Ecommerce: Tonomy ID Enables Seamless Secure Payment and Solutions</h1>
                            <p>Enhance Security, Privacy, and Convenience with Tonomy ID. Upgrade your online store with our user-friendly tech. Protect your data and enjoy a safer eCommerce future today.</p>
