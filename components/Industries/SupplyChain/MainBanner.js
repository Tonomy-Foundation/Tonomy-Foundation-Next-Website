                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="banner-text">
                            <h1>Unchain Trust: Tonomy ID Reinventing Supply Chain Security</h1>
                            <p>We empower you to modernize your supply chain powered by self-sovereign identity technology. We enable full data portability and interoperability by creating the framework to move data across multiple parties. This enables full scale privacy whilst being able to hold every actor of your supply chain accountable. </p>
